...
##### Copy HTK Files over
rsync -rH --exclude "supplemental/" --progress ./ContinuousBigram/commands/ rsridhar37@login-phoenix.pace.gatech.edu:/storage/home/hcoda1/5/rsridhar37/p-ts133-0/ASL/fingerspelling/ContinuousBigram/commands
rsync -rH --exclude "supplemental/" --progress ./ContinuousBigram/dict/ rsridhar37@login-phoenix.pace.gatech.edu:/storage/home/hcoda1/5/rsridhar37/p-ts133-0/ASL/fingerspelling/ContinuousBigram/dict
rsync -rH --exclude "supplemental/" --progress ./ContinuousBigram/grammar/ rsridhar37@login-phoenix.pace.gatech.edu:/storage/home/hcoda1/5/rsridhar37/p-ts133-0/ASL/fingerspelling/ContinuousBigram/grammar
rsync -rH --exclude "supplemental/" --progress ./ContinuousBigram/mlf/ rsridhar37@login-phoenix.pace.gatech.edu:/storage/home/hcoda1/5/rsridhar37/p-ts133-0/ASL/fingerspelling/ContinuousBigram/mlf
