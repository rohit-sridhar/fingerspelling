...
OUTPUTFILE_ROOT=${PRJ}/output/dim20/thr1/train/ptd05c/sd1248
...
GRAMMARFILE_ROOT=${PRJ}/grammar/dim20/thr1/train/ptd05c/sd1248
...
DICTFILE_ROOT=${PRJ}/dict/dim20/thr1/train/ptd05c/sd1248
...
TOKENS_ROOT=${PRJ}/commands/dim20/thr1/train/ptd05c/sd1248
...
MLF_ROOT=${PRJ}/mlf/dim20/thr1/train/ptd05c/sd1248
...
LEDFILE_UNIQ=dim20_thr1_train_ptd05c_sd1248
...
EXT_DIR=${PRJ}/ext/dim20/thr1/train/ptd05c/sd1248
...
LOG_RESULTS=${PRJ}/results/dim20/thr1/train/ptd05c/sd1248/hresults.log_letter_neg10ip_4state-pca20-gmm2_20its_5tri-its_tc50
LOG_RESULTS_WORD=${PRJ}/results/dim20/thr1/train/ptd05c/sd1248/hresults.log_word_neg10ip_4state-pca20-gmm2_20its_5tri-its_tc50

HMM_TEMP_DIR=${PRJ}/models/dim20/thr1/train/ptd05c/sd1248
