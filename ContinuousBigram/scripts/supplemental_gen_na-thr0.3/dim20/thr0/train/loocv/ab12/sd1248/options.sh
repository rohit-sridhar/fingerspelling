...
NUM_HMM_DIR=50 # number of hmm dirs to generate, has a direct relation to number of times HERest is called
TRI_ITERATIONS=100 # number of HERest calls to make for triletter stages
...
OUTPUTFILE_ROOT=${PRJ}/output/supplemental_gen_na-thr0.3/dim20/thr0/train/loocv/ab12/sd1248
...
GRAMMARFILE_ROOT=${PRJ}/grammar/supplemental_gen_na-thr0.3/dim20/thr0/train/loocv/ab12/sd1248
...
DICTFILE_ROOT=${PRJ}/dict/supplemental_gen_na-thr0.3/dim20/thr0/train/loocv/ab12/sd1248
...
TOKENS_ROOT=${PRJ}/commands/supplemental_gen_na-thr0.3/dim20/thr0/train/loocv/ab12/sd1248
...
MLF_ROOT=${PRJ}/mlf/supplemental_gen_na-thr0.3/dim20/thr0/train/loocv/ab12/sd1248
...
LEDFILE_UNIQ=supplemental_gen_na-thr0.3_dim20_thr0_train_loocv_ab12_sd1248
...
EXT_DIR=${PRJ}/ext/supplemental_gen_na-thr0.3/dim20/thr0/train/loocv/ab12/sd1248
...
LOG_RESULTS=${PRJ}/results/supplemental_gen_na-thr0.3/dim20/thr0/train/loocv/ab12/sd1248/hresults.log_letter_neg10ip_6state-pca20-gmm2_50its_100tri-its_tc50
LOG_RESULTS_WORD=${PRJ}/results/supplemental_gen_na-thr0.3/dim20/thr0/train/loocv/ab12/sd1248/hresults.log_word_neg10ip_6state-pca20-gmm2_50its_100tri-its_tc50

HMM_TEMP_DIR=${PRJ}/models/supplemental_gen_na-thr0.3/dim20/thr0/train/loocv/ab12/sd1248
