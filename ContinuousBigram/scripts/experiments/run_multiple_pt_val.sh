...
# typeset -a datasets=(${base_dataset}_drop-na_lininterp0 ${base_dataset}_na-thr0.3_drop-na_lininterp0 ${base_dataset}_na-thr0.5_drop-na_lininterp0)
typeset -a datasets=(${base_dataset}_drop-na_lininterp0)
typeset -a participants=(b718 1d72 f066 7f32 3a6e)
...
############################## USER DEP TEST ###############################
# 
# output_dir=results/pt_results/tst/${dataset}
# 
# if [ ! -d ${output_dir} ]; then
#     mkdir -p ${output_dir}
# fi
...
#             --test_model_path  ${model_path} \
#             --ip_values -100 -75 -50 -25 -10 0 10 \
