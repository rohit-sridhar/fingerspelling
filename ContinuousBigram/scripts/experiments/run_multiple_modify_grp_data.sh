    ...
    for grp in "${ptgrps[@]}"; do
        for seed in "${seeds[@]}"; do
            for threshold in "${thresholds[@]}"; do
                python scripts/modify_data.py --data_loc ./data/supplemental/dl_cmp/dim20/thr0/${data_split}/grp${grp}/sd${seed}/data --label_loc ./label/supplemental/dl_cmp/thr0/${data_split}/grp${grp}/sd${seed}/label --new_data_loc ./data/supplemental/dl_cmp/dim20/thr${threshold}/${data_split}/grp${grp}/sd${seed}/data --new_label_loc ./label/supplemental/dl_cmp/thr${threshold}/${data_split}/grp${grp}/sd${seed}/label --method fpl_threshold --fpl_threshold ${threshold}
            done
        done
    done
done
        ...
        for seed in "${seeds[@]}"; do
            for threshold in "${thresholds[@]}"; do
                for interpolation in "${interpolations[@]}"; do
                    python scripts/modify_data.py --data_loc ./data/supplemental/dl_cmp/dim20/thr${threshold}/${data_split}/grp${grp}/sd${seed}/data --label_loc ./label/supplemental/dl_cmp/thr${threshold}/${data_split}/grp${grp}/sd${seed}/label --new_data_loc ./data/supplemental/dl_cmp/dim20/thr${threshold}/${data_split}/interpall${interpolation}/grp${grp}/sd${seed}/data --method interpolation --num_interpolations ${interpolation} --interp_all
                done
            done
        done
    done
