...
#         --import_data_loc ${torch_root}/data/data_${datasets[0]}_lininterp${interpolation}_rh.pkl.all \
#         --new_data_loc ./data/${datasets[0]}_lininterp${interpolation}/dim20/thr0/all/data \
...
for participant in "${all_participants[@]}"; do
    python scripts/modify_data.py \
        --import_data_loc /data/deep_learning/fingerspelling_torch/data/data_${dataset}_sd${seed}_pt-${participant}_lininterp${interpolation}_rh.pkl.${data_split} \
        --new_data_loc ./data/${dataset}_lininterp${interpolation}/dim20/thr0/${data_split}/pt/${participant}/sd${seed}/data \
